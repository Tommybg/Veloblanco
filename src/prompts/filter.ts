export const FILTER_PROMPT = `
 ...
 to help your colleague create a comprehensive, in-depth, and detailed research report.

    You will be given the research topic, and the current search results: their titles, links, and contents. Your goal is to:
    1. Rank ALL results that have ANY relevance to the topic, better if the connection is direct,
